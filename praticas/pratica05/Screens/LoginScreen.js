...
function LoginScreen() {
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Button mode="contained" onPress={() => {}} style={styles.input}>Entrar
        Entrar
      </Button>
      <Text variant="displaySmall" style={styles.title}>Login
      <Text style={styles.info}>Esqueceu sua senha? <Text style={styles.link}>Recuperar senha</Text>
      </Text>
